...
g = Graph()
i = int(input('โปรดระบุจำนวนจุดในกราฟ: '))
n = 0
while n<i:
...
while True:
    print('โปรดระบุเส้นเชื่อมโดยระบุชื่อจุดที่เป็น source และ destination')
...
n=input('ชื่อจุดที่เป็นจุดเริ่มต้นในการท่องไปในกราฟ = ')
g.bfs(n)